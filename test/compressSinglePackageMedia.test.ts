...
test('compresses a single referenced file and dispatches bulkMediaCompressed exactly once', async () => {
    ...
    expect(actionTypes(harness.dispatch).filter(t => t === 'siquester/bulkMediaCompressed')).toHaveLength(1);
